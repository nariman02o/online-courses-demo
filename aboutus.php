...
<body>
  ...
  <main id="main">
    ...
    <div class="breadcrumbs" data-aos="fade-in">
      <div class="container">
        <h2>About Us</h2>
        <p>Our mission is to empower individuals, organizations, and educational institutions with the tools they need to succeed in a rapidly evolving world. We believe that knowledge has the power to transform lives and drive positive change. By providing a wide range of online courses and a user-friendly learning environment, we aim to facilitate learning for everyone, regardless of their age, background, or location.</p>
      </div>
    </div><!-- End Breadcrumbs -->
